...
class Category:
  ...
  def deposit(self, amount, description=""):
    """
    A desposit method that accepts an amount and 
    description. If no description is given, it should 
    default to an empty string. The method should append on 
    an object to the ledger list in the form of {"amount": 
  ...
  def withdraw(self, amount, description=""):
    ...
    amount passed in should be stored in the ledger as a negative 
  ...
  def transfer(self, amount, category):
    ...
    the amount and the description "Transfer from [Source Budget 
    Category]". If there are not enough funds, nothing should be added 
    to either ledgers. This method should return True if the transfer 
